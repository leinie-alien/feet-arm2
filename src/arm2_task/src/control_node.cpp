...
void ControlNode::publish_static_camera_tf()
{
    ...
    auto pos = this->declare_parameter("camera_extrinsics.pos", std::vector<double>{0.05, 0.0, 0.02});
    auto quat = this->declare_parameter("camera_extrinsics.quat", std::vector<double>{0.0, 0.0, 0.0, 1.0});
